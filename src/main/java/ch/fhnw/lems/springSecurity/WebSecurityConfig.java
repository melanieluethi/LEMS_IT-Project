...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/api/productById/{productId}").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				.antMatchers("/api/productByName/{productName}").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				.antMatchers("/api/addProductToart").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				.antMatchers("/api/shoppingCart/{userId}").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				.antMatchers("/api/changeProduct").hasRole(USER_ROLE_ADMIN)
				.antMatchers("/api/order/").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				.antMatchers("api/order/{orderId}").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				.antMatchers("/api/orders").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				.antMatchers("/api/changeLanguage").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				.antMatchers("/api/language").permitAll()
				.antMatchers("/api/transportCostCart").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				.antMatchers("/api/transportCostOrder/{orderId}").hasAnyRole(USER_ROLE_ADMIN, USER_ROLE_USER)
				// Rights for views
				...
				.antMatchers("/userManagement").hasRole(USER_ROLE_USER)
				.antMatchers("/orderDetail").hasRole(USER_ROLE_USER)
