	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
				...
				// Rights for views
				.antMatchers("adminOrdersView").hasAnyRole(UserRole.ADMIN.name())
				.antMatchers("adminProductsView").hasAnyRole(UserRole.ADMIN.name())				
				.antMatchers("adminUsersView").hasAnyRole(UserRole.ADMIN.name())
				.antMatchers("adminView").hasAnyRole(UserRole.ADMIN.name())		
